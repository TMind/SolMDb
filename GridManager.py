...
class DynamicGridManager:
    ...
    def reload_data_on_click(self, button, value):
        ...
        operation_in_progress = False  # This should be managed within the class context
        ...
        try:
            username_value = ''  # Retrieve the username from the appropriate widget or variable
            if hasattr(gv, 'username'):
                username_value = gv.username
            ...
            if value == 'Load Decks/Fusions':
                ...
                combo_df = self.data_generate_functions['find_combos']()
            ...
            self.data_generate_functions['load_deck_data'](args)
            ...
            if hasattr(gv.myDB, 'mdb'):
                ...
                if valid_db_names:
                    ...
                    db_list_widget = self.get_ui_widget('Additional Controls').children[4]  # Assuming db_list is the 5th widget
                    ...
                    db_list_widget = self.get_ui_widget('Additional Controls').children[4]
    ...
    def update_count_display(self, display_data):
        ...
        """
        count_display = self.get_ui_widget('Additional Controls').children[3]  # Assuming count_display is the 4th widget
