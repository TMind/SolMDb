...
c.Authenticator.admin_users = { 'codespace' }
...
#  Default: '/opt/conda/envs/SolDB-Conda/share/jupyterhub'
# c.JupyterHub.data_files_path = '/opt/conda/envs/SolDB-Conda/share/jupyterhub'
